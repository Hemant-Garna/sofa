...
export function Footer({ onScrollToSection, onOpenVIPModal }: FooterProps) {
  ...
  return (
    <footer className="bg-[#1C1917] text-[#FAF8F5] border-t border-white/10 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Brand Provenance & Value Pillars */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-14 border-b border-white/10 text-xs">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-white uppercase tracking-wider text-[11px]">10-Year Framework Warranty</h4>
              <p className="text-[#FAF8F5]/60 mt-1 leading-relaxed">
                Kiln-dried hardwood frames with double-dowelled, mortise-and-tenon structural joinery.
              </p>
            </div>
          </div>
        ...
        <div className="py-14 grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-xs text-[#FAF8F5]/70 max-w-sm leading-relaxed font-light">
            ...
            <div className="text-[11px] text-[#FAF8F5]/50 space-y-1 font-mono">
